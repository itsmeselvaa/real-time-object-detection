...
from videoo import video_detection
app = Flask(__name__)

app.config['SECRET_KEY'] = 'selva'
...
@app.route('/video')
def video():
    #return Response(generate_frames(path_x='templates/files/bikes.mp4'), mimetype='multipart/x-mixed-replace; boundary=frame')
